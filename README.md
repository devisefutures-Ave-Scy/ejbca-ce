...
Gryphus Gripsholms CA is an open-source Public Key Infrastructure (PKI) and Certificate Authority (CA) software based on EJBCA-CE. It adds support for:

+ Key pair generation and signing of Edwards curves (ed25519) using the Utimaco HSM
+ Exporting  security audit logs to an external file
+ Signing and exporting security audit logs to an external file
+ A database integrity protection mechanism.
